...
class MapScreenState extends State<MapScreen> {
  ...
  void _addMarkerToList(LatLng pos, String markerIdVal,
    ...
    final marker = _newMarker(markerId, pos, isYellowMarker: isYellowMarker);

    markers[markerId] = marker;
  }

  Marker _newMarker(MarkerId markerId, LatLng pos,
      {bool isYellowMarker = false}) {
  ...
  void _toggleToRelocateContainerMode() {
    ...
    final redrawnMarker = _newMarker(selectedMarkerId, targetMarker.position,
        isYellowMarker: true);
